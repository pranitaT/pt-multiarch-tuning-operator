...
const (
	...
	// CELProcessedLabel indicates pod was processed by CEL in webhook
	CELProcessedLabel = "multiarch.openshift.io/cel-processed"
	// CELProcessedLabelValue is the value for successfully processed CEL pods
	CELProcessedLabelValue         = "processed"
